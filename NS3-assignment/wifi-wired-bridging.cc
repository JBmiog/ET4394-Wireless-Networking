...
void simulator(uint32_t nWifis, uint32_t nStas, bool writeMobility, bool debug, DataRate dataRate){
...
*/
	...
	// use the Random Direction 2D Node Mobility Model
	...
	uint32_t nStaNodes = sta.GetN();
		//print node and wifi ID and IP addresses of wifi stations
		if(debug){
  ...
  //print addresses and node ID's of wifi ap nodes
  if(debug){
	Ipv4Address addr;
  ...
  //we could generate the Pcap files to look into the traffic using wireshark
  ...
  //std::cout << "nAP " << "nSta" << "nSta/Ap" << "average throughput";
  std::cout <<  nWifis << " " << nStas*nWifis << " " << nStas << " " <<  totalThroughPut / totalNFlows << " " << dataRate << "\n";
}
...
int main (int argc, char *argv[])
{
	...
	cmd.Parse (argc, argv);
	if(debug){
		simulator(nWifis, nStas, writeMobility, debug, dataRate);
	} else {
		simulator(30, 1, writeMobility, debug, 11000*1000);
		simulator(15, 2, writeMobility, debug, 11000*1000);
		simulator(10, 3, writeMobility, debug, 11000*1000);
		simulator(6, 5,  writeMobility, debug, 11000*1000);
		simulator(5, 6,  writeMobility, debug, 11000*1000);
		simulator(3, 10,  writeMobility, debug, 11000*1000);
		simulator(2, 15,  writeMobility, debug, 11000*1000);

		simulator(30, 1, writeMobility, debug, 5500*1000);
		simulator(15, 2, writeMobility, debug, 5500*1000);
		simulator(10, 3, writeMobility, debug, 5500*1000);
		simulator(6, 5,  writeMobility, debug, 5500*1000);
		simulator(5, 6,  writeMobility, debug, 5500*1000);
		simulator(3, 10,  writeMobility, debug, 5500*1000);
		simulator(2, 15,  writeMobility, debug, 5500*1000);

		simulator(30, 1, writeMobility, debug, 2000*1000);
		simulator(15, 2, writeMobility, debug, 2000*1000);
		simulator(10, 3, writeMobility, debug, 2000*1000);
		simulator(6, 5,  writeMobility, debug, 2000*1000);
		simulator(5, 6,  writeMobility, debug, 2000*1000);
		simulator(3, 10,  writeMobility, debug, 2000*1000);
		simulator(2, 15,  writeMobility, debug, 2000*1000);

		simulator(30, 1, writeMobility, debug, 1000*1000);
		simulator(15, 2, writeMobility, debug, 1000*1000);
		simulator(10, 3, writeMobility, debug, 1000*1000);
		simulator(6, 5,  writeMobility, debug, 1000*1000);
		simulator(5, 6,  writeMobility, debug, 1000*1000);
		simulator(3, 10,  writeMobility, debug, 1000*1000);
		simulator(2, 15,  writeMobility, debug, 1000*1000);
	}
}
